...
const PostCard = ({ postData, usersData, onFollowUpdate }) => {
  ...
  const CardContent = () => (
    <article className="rounded-xl p-4 flex flex-col gap-4 border border-gray-200 h-full bg-white">
      ...
      {image && (
        <img src={image} alt={titleText} className="w-full h-auto border p-1 border-gray-200 max-h-[500px] object-contain rounded-lg md:mb-5" />
      )}
      ...
      <div>
        ...
        <div>
          {postData?.author_profession === "Developer" ? (
            ...
            <div>
              ...
              <div className="text-gray-600 flex items-center gap-1 text-sm mt-2">
              ...
              <div className="bg-white rounded-2xl shadow-md pb-5 px-6 border border-gray-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="flex justify-between items-center mb-3">
                  <h2 className="text-2xl font-semibold text-gray-800 line-clamp-2">
                    {postData?.extraFields?.storyTitle}
                  </h2>
                ...
                {/* Full Content (optional preview) */}
                <div>
                  <p className="leading-relaxed mb-4">
                    {showFull ? postData?.extraFields?.fullContent : postData?.extraFields?.fullContent?.slice(0, 500)}...
                ...
                <p className="text-sm text-gray-500 italic mb-2">
                  ✍️ Writing Style: {postData?.extraFields?.writingStyle}
                </p>
              </div>
          ...
          {postData?.author_profession === "Blogger"
            ? (
              <div className="bg-white rounded-2xl shadow-md pb-5 px-6 border border-gray-100 hover:shadow-lg transition-all duration-300">
                ...
                {/* Mood */}
                <p className="text-sm mt-6 text-gray-500 italic mb-3">
        ...
        <div>
          {postData?.author_profession === "Designer"
            ? (
              <div className="bg-white rounded-2xl shadow-md border border-gray-100 pb-5 px-6 hover:shadow-lg transition-all duration-300">
                {/* Header */}
                <div className="flex justify-between items-center mb-3">
                ...
                {postData?.extraFields?.feedbackNote && (
                  <div className=" mt-3 pt-3 text-sm text-gray-600 italic">
                    💬 “{postData.extraFields.feedbackNote}”
                  </div>
                )}
              </div>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-start justify-center z-50 overflow-y-auto p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full relative flex flex-col">
            ...
            <div className="flex gap-2 border-t border-gray-200 p-3 bg-white">
              <img src={session?.user?.image || "/defult_profile.jpg"} alt="user" className="w-10 h-10 rounded-full" />
              <input
                type="text"
                ...
                comments.map((comment) => {
                  ...
                  return (
                    <div key={comment.id} className="flex gap-2">
                      <img src={comment.comment_author_image || "/defult_profile.jpg"} alt="" className="w-8 h-8 rounded-full" />
