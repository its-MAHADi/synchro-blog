...
const FAQ = () => {
    ...
    return (
        <div id="faq" className='mt-25 max-w-screen-xl mx-auto px-4 flex justify-center items-center flex-col'>
            <div className="inline-flex flex-row-reverse items-center gap-2 bg-[#c45627] px-4 py-2 rounded-full mb-4">
                ...
                <span className="md:text-xl lg:text-2xl font-medium text-[#f6f5ea]">Got questions? We’re here to help</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl text-center font-bold bg-gradient-to-tr from-[#853716] via-[#ec9975] to-[#853716] bg-clip-text text-transparent mb-10">Frequently Asked Questions</h1>
