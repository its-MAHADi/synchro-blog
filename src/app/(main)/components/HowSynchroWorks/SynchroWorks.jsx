...
const steps = [
  {
    id: 1,
    icon: <FaRobot size={26} className="text-[#0000FF]" />,
  ...
  {
    id: 2,
    icon: <FaSearch size={26} className="text-[#0000FF]" />,
  ...
  {
    id: 3,
    icon: <FaGlobe size={26} className="text-[#0000FF]" />,
  ...
  {
    id: 4,
    icon: <FaQuestionCircle size={26} className="text-[#0000FF]" />,
  ...
  {
    id: 5,
    icon: <FaShareAlt size={26} className="text-[#0000FF]" />,
  ...
  {
    id: 6,
    icon: <FaChartLine size={26} className="text-[#0000FF]" />,
    ...
    >
      ...
      {isEven ? (
        <div className="hidden lg:block w-1/2 pr-8 text-right">
          <h3 className="text-2xl font-bold text-[#0000FF]">{step.title}</h3>
      ...
      <motion.div
        ...
        className="hidden lg:flex relative items-center justify-center w-12 h-12 bg-white border-4 border-[#0000FF] rounded-full z-10 shadow-lg"
      >
        {step.icon}
      </motion.div>
  ...
  return (
    <section className="max-w-screen-xl mx-auto px-4 mt-20 mb-20">
      ...
      <div className="relative container mx-auto py-16">
        {/* Vertical line */}
        <div className="hidden lg:block absolute left-1/2 top-0 w-1 h-full bg-[#0000FF] transform -translate-x-1/2"></div>
