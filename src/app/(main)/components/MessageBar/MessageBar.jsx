...
const MessageBar = () => {
  ...
  const Message = ({ msg }) => {
    ...
    return (
      <div className={`flex mb-3 ${isUser ? "justify-end" : "justify-start"}`}>
        {/* Assistant avatar */}
        {!isUser && (
          <img className="w-8 h-8 rounded-full mr-2 flex-shrink-0 self-start" src="/ai_assistant_logo.jpg" alt="ai" />
        )}

        {/* Message bubble */}
        <div
          className={`px-4 py-2  rounded-2xl max-w-xs md:max-w-md ${isUser
  ...
  return (
    <div className="flex flex-col max-w-2xl mx-auto h-[80vh] rounded-2xl shadow-lg bg-gray-50">
      {/* Header */}
      <div className="p-4 border-b border-gray-200 flex items-center">
        <img src="/ai_assistant_logo.jpg" className="w-10 h-10 rounded-full" alt="ai-assistant" />
        <div className="ml-3">
          <h2 className="font-semibold text-lg text-gray-800">AI Assistant</h2>
