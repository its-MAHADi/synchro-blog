                ...
                <div className="relative max-w-7xl mx-auto">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
                            Discover amazing events, connect with like-minded people, and grow your network.
                            ...
                            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            <option value="all" className="text-gray-800">All Events</option>
                                            <option value="upcoming" className="text-gray-800">Upcoming</option>
                                            <option value="past" className="text-gray-800">Past Events</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    {filteredEvents.length > 0 ? (
                        <div className="space-y-8">
                                            ...
                                            >
                                                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                                                    <div className="flex-1">
                                                        ...
                                                        <p className="text-white/90 mb-4 text-lg leading-relaxed">{event.description}</p>
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-[#213943] mb-6">
                                    {filteredEvents.some(event => event.featured) ? 'More Events' : 'All Events'}
                                </h2>
                                    ...
                                    {filteredEvents.filter(event => !event.featured).map((event) => (
                                        ...
                                        >
                                            <div className="p-6">
                                                ...
                                                <h3 className="text-xl font-bold text-[#213943] mb-3">{event.title}</h3>
                        ...
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-2xl font-bold text-[#213943] mb-4">No Events Found</h3>
                            <p className="text-gray-600 mb-6">Try adjusting your search criteria or filters to find more events.</p>
                            <button
                                onClick={() => {
                                    setSearch("");
                                    setFilter("all");
